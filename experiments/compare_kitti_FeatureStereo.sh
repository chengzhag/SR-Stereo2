...
# (SERVER 162) EDSRfeaturePSMNet_pretrainedSR_stereoUpdate: load EDSR pretrained with kitti and only update body
...
# (SERVER 95) EDSRfeaturePSMNet_allUpdate lr test
# EDSRfPSMNet_lr_0.0005_allUpdate (better: RUNNING)
