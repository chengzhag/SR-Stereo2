...
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 1 0.5
...
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 300 --half --argument 1.5 0.75
...
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint logs/experiments/compare_kitti_SRStereo_Stereo/Stereo_train/190504082252_model_SRStereo_EDSR_PSMNet_loadScale_1.0_trainCrop_64_512_batchSize_12_4_lossWeights_-1.0_0.0_1.0_kitti2015/checkpoint_epoch_0600_it_00014.tar --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 600 0.0002 900 0.0001 1200 0.00005 1500 0.00002 1800 0.00001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 300 --half --argument 1.5 0.75 --resume toNew
# result: no need training 2400 epochs and '0.001 300 0.0005 450 0.0002 600 0.0001' is good enough

## compare: bilinear interpolation
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo Bilinear PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint None $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 1.5 0.75
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo Bilinear PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint None $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half

## (SERVER 95) finnal KITTI train
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 1.5 0.75
PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR PSMNet --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_DIV2K_EDSR_baseline_x2 $pretrained_kitti2015_PSMNet_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half
...
# argumentation: scale from 1 to 0.5
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR GwcNetGC --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_GwcNetGC_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 1 0.5
# argumentation: scale from 2 to 1 (lr_slowDecay)
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR GwcNetGC --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_GwcNetGC_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 600 0.0002 900 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 2 1
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR GwcNetG --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_GwcNetG_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 600 0.0002 900 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 200 --half --argument 2 1
...
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR GwcNetGC --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline $pretrained_kitti2015_GwcNetGC_trainSet --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 400 0.0005 800 0.0002 1200 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 30 --saveEvery 300 --half --argument 1.75 0.63
...
#PYTHONPATH=./ python train/Stereo_train.py --model SRStereo EDSR GwcNetG --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 2 --dataPath $kitti2015_dataset --dataset kitti2015 --chkpoint $pretrained_kitti2015_EDSRbaseline_trainSub $pretrained_kitti2015_GwcNetG --loadScale 1 --batchSize 12 $nGPUs --trainCrop 64 512 --evalFcn outlier --epochs 1200 --lr 0.001 300 0.0005 450 0.0002 600 0.0001 --lossWeights -1 0 1 --logEvery 50 --testEvery 0 --saveEvery 300 --half --argument 1.75 0.63 --subType trainSub
# submission
#PYTHONPATH=./ python evaluation/Stereo_eval.py --model GwcNetGC --outputFolder experiments/compare_kitti_SRStereo_Stereo --dispScale 1 --dataPath $kitti2015_dataset_testing --dataset kitti2015 --chkpoint $pretrained_kitti2015_GwcNetGC --loadScale 1 --batchSize 0 1 --evalFcn outlier --half --noComet --subType subTest --resume toOld
