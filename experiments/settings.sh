...
pretrained_carla_PSMNetDown=${experiment_dir}/pretrain_carla_Stereo_StereoDown/Stereo_train/190409094503_PSMNetDown_loadScale_1.0_0.5_trainCrop_128_1024_batchSize_12_4_lossWeights_0.8_0.2_carla
pretrained_carla_PSMNet=${experiment_dir}/pretrain_carla_Stereo_StereoDown/Stereo_train/190409192918_PSMNet_loadScale_0.5_trainCrop_128_1024_batchSize_12_4_lossWeights_1_carla

# checkpoints: pretrain_carla_SR_SRdisp
pretrained_carla_EDSRbaseline=${experiment_dir}/pretrain_carla_SR_SRdisp/SR_train/
