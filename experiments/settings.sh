...
pretrained_kitti2015_GwcNetG=${experiment_dir}/compare_kitti_SRStereo_Stereo/Stereo_train/
pretrained_kitti2015_EDSRbaselineGwcNetG_trainSub=${experiment_dir}/compare_kitti_SRStereo_Stereo/Stereo_train/
...
pretrained_sceneflow_GwcNetG=${experiment_dir}/pretrain_sceneflow_Stereo/Stereo_train/
